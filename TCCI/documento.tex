...
\autor{Kauan Cavalcante}
\titulo{Desenvolvimento de um Sistema para Automatização de Processos da Associação de Apicultores de Poranga: Uma Abordagem Baseada em Engenharia de Software e TDD}
\data{2026}
\local{Quixadá}
...
\orientadorcentro{Campus da UFC em Quixadá}
...
\coorientador{Francisco Jerferson Martins da Silva}
\coorientadories{Universidade Federal do Ceará (UFC)}
\coorientadorcentro{Campus Quixadá (UFC)}
...
\begin{document}	
	...
	\input{2-textuais/trabalhos-relacionados.tex}
	...
	\cite{pinto2016construcao}
	\cite{oliveira2021analise}
	\cite{maciel2024aplicacao}
