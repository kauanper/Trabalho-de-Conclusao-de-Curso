...
\begin{itemize}
    \item Elicitar os requisitos do sistema por meio de Prototipação Exploratória, conduzida em ciclos iterativos junto a stakeholders representativos dos diferentes cargos da associação, de modo a compensar a baixa familiaridade desse público com ferramentas digitais e processos formais de especificação;
    \item Especificar formalmente os requisitos levantados, de forma a garantir rastreabilidade entre os requisitos e os testes a serem desenvolvidos;
    \item Modelar a arquitetura do sistema, definindo a estrutura do banco de dados e a organização do código-fonte da aplicação antes da implementação;
    \item Implementar a aplicação por meio do Desenvolvimento Orientado por Testes (TDD), construindo uma suíte de testes automatizados que assegure a confiabilidade das regras de negócio ao longo da evolução do sistema;
    \item Avaliar a usabilidade da aplicação junto a associados representativos do perfil de uso comum, de modo a verificar se a ferramenta favorece o acesso transparente às informações por todo o grupo.
\end{itemize}

\section{Organização do Trabalho}
\label{sec:orgnaizacao}

Este trabalho está organizado da seguinte forma: o Capítulo 2 apresenta a fundamentação teórica, discutindo a apicultura no semiárido, o associativismo sob a perspectiva da Economia Solidária, a confiança organizacional e os conceitos de Engenharia de Software que sustentam a proposta. O Capítulo 3 traz os trabalhos relacionados, posicionando esta proposta em relação a soluções já existentes para a gestão de apicultores e associações. O Capítulo 4 descreve a metodologia adotada para o desenvolvimento do sistema, detalhando as etapas previstas desde a elicitação dos requisitos até a avaliação da aplicação.