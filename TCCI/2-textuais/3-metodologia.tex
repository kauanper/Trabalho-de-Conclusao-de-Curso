...
A avaliação será conduzida por meio de \textbf{Testes de Usabilidade com Usuários}, nos quais os stakeholders selecionados serão convidados a realizar um conjunto de tarefas predefinidas no sistema, enquanto suas dificuldades e comportamentos forem observados \cite{nielsen1993}. As tarefas serão elaboradas a partir das principais histórias de usuário, cobrindo os fluxos de uso mais representativos da aplicação.
