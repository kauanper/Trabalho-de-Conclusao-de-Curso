...
O Quadro \ref{tab:comparativo} sintetiza essas diferenças, evidenciando que a convergência entre domínio apícola, governança associativa, verificação automatizada e acessibilidade mobile, proposta neste trabalho, não encontra equivalente nos sistemas revisados.
...
\hline
\textbf{Critério} & \textbf{SisFarming} & \textbf{APISAPP} & \textbf{Colonymon} & \textbf{Oliveira et al.} & \textbf{Este Trabalho} \\
& \textbf{(2026)} & \textbf{(2016)} & \textbf{(2024)} & \textbf{(2021)} & \textbf{(2026)} \\
\hline
Domínio específico & Agric. Familiar & Apicultura & Apicultura & Associações & \textbf{Assoc. Apícola} \\
\hline
Foco principal & Institucional & Individual & Produtiva & Institucional & \textbf{Institucional} \\
\hline
Metodologia de V\&V & Não especificado & Manual & Manual & feedback/pair review & \textbf{TDD (Automat.)} \\
\hline
Estratégia de interface & Híbrida & Mobile/Web & Web & Web & \textbf{Mobile First} \\
\hline
Base tecnológica & Pascal/Delphi & Low-code & React/Next.js & API/MongoDB & \textbf{Go/Next.js} \\
\hline
Economia Solidária & Não & Não & Não & Não & \textbf{Sim (Central)} \\
\hline
\end{tabular}
}
\end{table}