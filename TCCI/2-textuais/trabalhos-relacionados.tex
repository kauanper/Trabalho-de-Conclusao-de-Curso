...
Além do diferencial metodológico proporcionado pela adoção do TDD, a solução proposta neste trabalho também se distingue da apresentada por \citeonline{oliveira2021analise} ao adotar a estratégia Mobile First. Enquanto os autores direcionam sua solução para portais administrativos de uso predominantemente web, a aplicação a ser desenvolvida utilizará tecnologias como Go e Next.js para entregar uma solução simultaneamente robusta do ponto de vista lógico e acessível à realidade dos produtores rurais.
...
Essa lacuna de domínio é acompanhada por uma lacuna metodológica de mesma natureza. Conforme apresentado nas seções anteriores, a confiabilidade do software é tratada de forma incidental nos trabalhos revisados, limitando-se a testes manuais ou à ausência de qualquer estratégia formal de verificação. Diante desse cenário, a adoção do Test-Driven Development neste trabalho não constituirá apenas uma escolha tecnológica, mas uma resposta direta à exigência de confiabilidade discutida na Seção \ref{sec:confiança}, na qual a credibilidade das informações compartilhadas entre os associados passará a depender também da forma como o sistema as tratará e apresentará.

A tabela \ref{tab:comparativo} sintetiza essas diferenças, evidenciando que a convergência entre domínio apícola, governança associativa, verificação automatizada e acessibilidade mobile, proposta neste trabalho, não possui equivalente nos sistemas revisados.
