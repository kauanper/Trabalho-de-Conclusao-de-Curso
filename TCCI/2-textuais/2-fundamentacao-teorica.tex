...
Ainda sobre o associativismo, é importante mencionar que ela herda principeios do que Paul Singer, criador do conceito, define como Economia Solidária. Alternativo ao capitalismo, esse conceito prioriza o desenvolvimento humano, social e politco em vez de uma simples acumulação de capital. 

Sendo assim, para que os benecifios da atividade economica estejam ao alcance de todos os que a realizam, a Economia Solidária segue 4 principios norteadores, que são eles: a Autogestão, onde define que a organização é gerida por todos trabalhadores, que serão coproprietários; A Solidariedade 
