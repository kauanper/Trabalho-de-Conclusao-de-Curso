...
Apesar do cenário favorável, a apicultura cearense ainda enfrenta barreiras relacionadas ao nível tecnológico e gerencial \cite{khan2009desempenho}. Pesquisas indicam que, enquanto as tecnologias de colheita são amplamente adotadas, com cerca de 81,19\%, as tecnologias de gestão apresentam a menor participação no índice tecnológico, com apenas 7,58\% de adoção \cite{khan2009desempenho}. Ou seja, o apicultor do cearense domina as técnicas de campo, como o uso de fumigadores, indumentária e centrífugas, mas negligencia a administração do negócio.
