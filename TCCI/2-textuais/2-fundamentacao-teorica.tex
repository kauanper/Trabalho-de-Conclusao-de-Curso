...
O conceito de Tecnologia Social emerge como uma alternativa ao modelo tradicional de desenvolvimento tecnológico, que historicamente privilegia os interesses de grupos economicamente dominantes em detrimento das necessidades das populações mais vulneráveis. Renato Dagnino define Tecnologia Social como o conjunto de técnicas e metodologias transformadoras desenvolvidas e aplicadas em interação com a população, que representam soluções para a inclusão social e melhoria das condições de vida.

No campo da Tecnologia Social, um conceito central é o de Adequação Sociotécnica (AST), que descreve o processo pelo qual artefatos tecnológicos são adaptados ou desenvolvidos de forma a atender aos interesses políticos e às necessidades específicas de grupos sociais que historicamente foram excluídos do processo de produção tecnológica. Diferentemente da lógica convencional, na qual a tecnologia é concebida para maximizar a produtividade e o lucro, a AST propõe um caminho inverso: partir das necessidades concretas dos usuários para, então, definir como a tecnologia deve ser construída e organizada.

Dagnino aponta que essa inversão não é apenas metodológica, mas também política, pois pressupõe que os próprios trabalhadores ou membros de uma organização participem ativamente das decisões sobre o desenvolvimento e o uso da tecnologia. Nesse sentido, a AST está intrinsecamente ligada aos princípios da autogestão e da democracia presentes na Economia Solidária, pois ambas as abordagens reconhecem que o controle sobre os meios de produção — incluindo as ferramentas tecnológicas — deve pertencer àqueles que delas fazem uso.

Essa perspectiva conecta-se diretamente com os princípios da Engenharia de Software, especialmente quando se considera que o desenvolvimento de um sistema eficiente deve partir de uma compreensão aprofundada das necessidades dos usuários. Assim como a AST propõe que a tecnologia seja moldada pelas demandas sociais, a Engenharia de Software orienta que os requisitos do sistema devem ser levantados junto aos usuários finais e que o processo de desenvolvimento deve ser validado continuamente em relação a esses requisitos. Essa convergência entre as duas abordagens indica que o desenvolvimento de tecnologias sociais pode se beneficiar significativamente das práticas e metodologias consolidadas pela Engenharia de Software.
