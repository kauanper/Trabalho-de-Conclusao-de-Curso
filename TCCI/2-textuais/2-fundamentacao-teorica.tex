...
A adoção de ferramentas tecnológicas em contextos associativos deve ser acompanhada de uma preocupação central com a confiabilidade do sistema utilizado. Isso porque, em organizações cujo funcionamento depende da confiança mútua entre seus membros, um sistema que apresenta falhas, inconsistências ou comportamentos inesperados pode ser ainda mais prejudicial do que a ausência de qualquer ferramenta, uma vez que compromete diretamente a credibilidade das informações apresentadas e, consequentemente, a confiança entre os associados.

Nesse sentido, a norma internacional ISO/IEC 25010, que define os modelos de qualidade para sistemas e softwares, estabelece a confiabilidade como uma das características fundamentais de qualidade de um produto de software. Essa característica abrange atributos como a maturidade do sistema, sua tolerância a falhas, a capacidade de recuperação diante de erros e a disponibilidade das funcionalidades ao longo do tempo. Um software confiável é aquele que se comporta de maneira consistente e previsível, mesmo diante de condições adversas, transmitindo aos usuários a segurança de que os dados apresentados refletem fielmente a realidade.
Sommerville reforça que muitos sistemas falham não por limitações técnicas, mas por não atenderem adequadamente às necessidades dos usuários ou por não serem suficientemente confiáveis no contexto em que são aplicados. Quando o software apresenta erros frequentes ou resultados inconsistentes, tende a ser rejeitado pelos seus usuários, que passam a questionar a integridade das informações geradas. No contexto de uma associação de apicultores, onde a transparência é o principal elo de coesão entre os membros, esse tipo de rejeição pode ser fatal para a continuidade do empreendimento coletivo.

Portanto, para que a tecnologia cumpra seu papel de suporte à autogestão e à transparência em associações, é imprescindível que o sistema seja desenvolvido com foco em confiabilidade desde as etapas iniciais do projeto. Isso implica adotar processos bem definidos de desenvolvimento, que incluam validação contínua do comportamento do sistema em relação às expectativas dos usuários, garantindo que os resultados apresentados sejam percebidos como fidedignos e consistentes com a realidade da associação.
